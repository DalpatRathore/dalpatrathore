...
```mermaid
  flowchart TB
    ...
    style b1 fill:#1d3461,stroke:#333,stroke-width:1px,color:#fff
    style b2 fill:#1d3461,stroke:#333,stroke-width:1px,color:#fff
    style b3 fill:#1d3461,stroke:#333,stroke-width:1px,color:#fff
    ...
    style c1 fill:#1d3461,stroke:#22223b,stroke-width:1px,color:#fff
    style c2 fill:#1d3461,stroke:#22223b,stroke-width:1px,color:#fff
    style c3 fill:#1d3461,stroke:#22223b,stroke-width:1px,color:#fff
